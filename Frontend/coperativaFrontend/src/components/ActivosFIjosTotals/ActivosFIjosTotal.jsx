            ...
            <section className="flex flex-col gap-3 border rounded-md p-2">
                ...
                {data.Fiscales && (
                    <>
                        ...
                        {renderSection(data.Fiscales, fiscalesDatosInformativosKeys, "Datos informativos: Valor activos adquiridos mediante arrendamiento financiero o leasing financiero")}
                    </>
                )}
            </section>
        </div>
