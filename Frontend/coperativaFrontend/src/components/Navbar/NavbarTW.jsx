const NavbarTW = ({ onCerrarSesion, onCrearProfesor, onActualizarDatos,onLista }) => {
    return (
      <nav className="flex justify-between items-center p-4 bg-[#18273E]">
        <h1 className="bg-[#18273E] font-semibold text-2xl text-unicoop-white my-auto">Administrador</h1>
