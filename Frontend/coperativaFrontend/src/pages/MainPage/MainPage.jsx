...
function MainPage() {
    ...
    return (
        <div className='flex flex-col justify-center items-center bg-[#1f324e] w-full h-screen'>
                <img className="w-[400px] md:w-[500px] md:h-[200px] rounded-[20%]" src="https://fernandocolmenares.co/wp-content/uploads/2020/08/U.CooperativaCol.png" alt="Logo" />
                ...
                <h3 className='text-white mt-[40px] p-4'>Si no eres estudiante, dale click <a className='text-cyan-400 hover:text-[#11a3f1]' href='/login'>aqui</a> para crear un codigo</h3>
