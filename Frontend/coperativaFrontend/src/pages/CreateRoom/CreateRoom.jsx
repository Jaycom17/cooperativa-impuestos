    ...
    return(
        <>
            ...
            <main className="w-full min-h-screen bg-background flex justify-center items-center flex-col">
                ...
                <p className="text-justify lg:text-center text-lg"> <InfoBubble info={'La sala se crea con estado inactivo'}/>A continuación, puede crear una sala. Una vez creada y activada, los estudiantes podrán ingresar y trabajar en la misma.</p>
                </article>
