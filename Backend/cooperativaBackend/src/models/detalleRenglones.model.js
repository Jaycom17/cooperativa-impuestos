...
export const DetalleRenglones = z.object({
  R33: z.object({
    510506: z.object({
      SaldCont: z.number(),
      Ajust1: z.number(),
  ...
  R84: z.object({
    ...
    AprtSocEncima: z.object({ Ajust1: z.number(), SaldFisc: z.number() }),
    TotFisc: z.number(),
  }),
  R85: z.object({
    Esc1: z.number(),
